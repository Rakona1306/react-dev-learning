...
/*
export default function Hijo({ onClick }: Props) {

  console.log('Hijo renderizando')
...
const Hijo = React.memo(({ onClick, nombre }: Props) => {

  const total = array.reduce((acum, val) => acum + val, 0)
